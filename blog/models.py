...
class Blog(models.Model):
    ...
    # category = models.ForeignKey(BlogCategory, on_delete=models.SET_DEFAULT, default=0)
...
class BlogComment(models.Model):
    ...
    blog = models.ForeignKey(Blog, on_delete=models.CASCADE, related_name="comments", verbose_name='关联博客')
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='评论发布者')
